...
export const EXPERIENCE = [
  {
    ...
    contents: [
      ...
      },
      {
        type: 'Frontend',
        texts: [
          'SNS 커뮤니티 웹뷰, 관리자페이지 개발',
          'Innopay, Utransfer 연계 환전(출금) 사용자페이지/관리자페이지 개발',
          'Innopay, Paypal 연계 PG결제 사용자페이지/관리자페이지 개발',
          '게임 아이템 마켓 플레이스 사용자페이지/관리자페이지 개발',
          'NFT마켓, 코인지갑, SNS 앱 3개 플랫폼간 통합 관리자페이지 개발'
        ]
      }
    ],
    skill: [
    ...
    contents: [
      {
        type: 'Backend',
        texts: [
          'Nest.js, Next.js 기반의 웹앱, 배치 설계/개발',
          '쿼리 튜닝을 통한 응답 속도 개선',
          'Nest.js, Next.js 기반의 웹애플리케이션, 관리자페이지 개발',
      ...
      {
        type: 'Etc',
        texts: ['하도급 업체(개발, 디자인)에게 프로젝트 발주 및 관리']
      }
    ],
    skill: [
      'Nest.js',
